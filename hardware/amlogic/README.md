...
Images using legacy Amlogic 3.14 or 4.9 Linux kernels often include an `install2internal` script to reconfigure and run LibreELEC from internal eMMC storage. We do not provide or support this script, and using it with modern`AMLGX` images will normally "brick" the box needing Amlogic Burning Tool and an Android factory image to recover the box. We do not support the script or Amlogic Burning Tool, and we do not have a secret collection of Android ROM images. <mark style="color:red;">**If you attempt internal installation and brick your Android box it will be your problem to solve. Do not expect support or sympathy from the forum staff.**</mark>
