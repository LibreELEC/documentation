...
In the above example `vpn_185_210_30_121_my_home_vpn` was created (vpn_Host_Domain) as the ConnMan service name. Test the service will connect using:
...
Replace **vpn_service_name_goes_here** with your service name, e.g. vpn_185_210_30_121_my_home_vpn using nano. Use `ctrl+o` to save changes and `ctrl+x` to exit nano:
